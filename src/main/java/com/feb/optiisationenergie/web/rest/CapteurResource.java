...
/**
 * REST controller for managing {@link com.feb.optiisationenergie.domain.Capteur}.
 */
@RestController
@RequestMapping("/api")
public class CapteurResource {
    ...
    public CapteurResource(CapteurService capteurService, CapteurRepository capteurRepository) {
    ...
    public ResponseEntity<Capteur> createCapteur(@RequestBody Capteur capteur) throws URISyntaxException {
        ...
        Capteur result = capteurService.save(capteur);
    ...
    public ResponseEntity<Capteur> updateCapteur(@PathVariable(value = "id", required = false) final Long id, @RequestBody Capteur capteur)
        ...
        Capteur result = capteurService.update(capteur);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Capteur> partialUpdateCapteur(
        ...
        Optional<Capteur> result = capteurService.partialUpdate(capteur);
    ...
    public ResponseEntity<Capteur> getCapteur(@PathVariable Long id) {
        ...
        Optional<Capteur> capteur = capteurService.findOne(id);
