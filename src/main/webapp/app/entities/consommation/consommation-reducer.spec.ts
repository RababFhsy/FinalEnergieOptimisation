...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSOMMATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONSOMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONSOMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONSOMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONSOMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONSOMMATION actions', async () => {
      const expectedActions = [
        {
