...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './etage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETAGE actions', async () => {
      const expectedActions = [
        {
