...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './capteur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPTEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAPTEUR actions', async () => {
      const expectedActions = [
        {
