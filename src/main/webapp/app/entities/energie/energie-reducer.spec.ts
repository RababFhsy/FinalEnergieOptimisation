...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './energie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENERGIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENERGIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENERGIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENERGIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENERGIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENERGIE actions', async () => {
      const expectedActions = [
        {
