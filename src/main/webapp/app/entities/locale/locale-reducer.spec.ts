...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './locale.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCALE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCALE actions', async () => {
      const expectedActions = [
        {
