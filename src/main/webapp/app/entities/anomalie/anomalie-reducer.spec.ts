...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './anomalie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANOMALIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANOMALIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANOMALIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANOMALIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANOMALIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANOMALIE actions', async () => {
      const expectedActions = [
        {
