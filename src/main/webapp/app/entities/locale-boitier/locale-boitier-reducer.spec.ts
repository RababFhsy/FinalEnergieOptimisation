...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCALEBOITIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCALEBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCALEBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCALEBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCALEBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCALEBOITIER actions', async () => {
      const expectedActions = [
        {
