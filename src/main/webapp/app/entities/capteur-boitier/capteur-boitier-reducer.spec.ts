...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPTEURBOITIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAPTEURBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAPTEURBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAPTEURBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAPTEURBOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAPTEURBOITIER actions', async () => {
      const expectedActions = [
        {
