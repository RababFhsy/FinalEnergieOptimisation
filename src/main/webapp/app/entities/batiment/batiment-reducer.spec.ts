...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './batiment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATIMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BATIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BATIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BATIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BATIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BATIMENT actions', async () => {
      const expectedActions = [
        {
