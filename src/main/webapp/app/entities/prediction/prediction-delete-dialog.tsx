...
export const PredictionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="feOptimisationEnergieApp.prediction.delete.question">
        Are you sure you want to delete Prediction {predictionEntity.id}?
      </ModalBody>
      <ModalFooter>
