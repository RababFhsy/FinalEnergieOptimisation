...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boitier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOITIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOITIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOITIER actions', async () => {
      const expectedActions = [
        {
