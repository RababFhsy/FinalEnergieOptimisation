...
class BoitierResourceIT {
    ...
    private static final String DEFAULT_BOITIER_REFERENCE = "AAAAAAAAAA";
    private static final String UPDATED_BOITIER_REFERENCE = "BBBBBBBBBB";
    ...
    public static Boitier createEntity(EntityManager em) {
        Boitier boitier = new Boitier().boitierReference(DEFAULT_BOITIER_REFERENCE).type(DEFAULT_TYPE).nbrBranche(DEFAULT_NBR_BRANCHE);
        return boitier;
    }
    ...
    public static Boitier createUpdatedEntity(EntityManager em) {
        Boitier boitier = new Boitier().boitierReference(UPDATED_BOITIER_REFERENCE).type(UPDATED_TYPE).nbrBranche(UPDATED_NBR_BRANCHE);
        return boitier;
    }
    ...
    void createBoitier() throws Exception {
        ...
        assertThat(testBoitier.getBoitierReference()).isEqualTo(DEFAULT_BOITIER_REFERENCE);
    ...
    void getAllBoitiers() throws Exception {
        ...
        restBoitierMockMvc
            ...
            .andExpect(jsonPath("$.[*].boitierReference").value(hasItem(DEFAULT_BOITIER_REFERENCE)))
    ...
    void getBoitier() throws Exception {
        ...
        restBoitierMockMvc
            ...
            .andExpect(jsonPath("$.boitierReference").value(DEFAULT_BOITIER_REFERENCE))
    ...
    void putExistingBoitier() throws Exception {
        ...
        updatedBoitier.boitierReference(UPDATED_BOITIER_REFERENCE).type(UPDATED_TYPE).nbrBranche(UPDATED_NBR_BRANCHE);
        ...
        Boitier testBoitier = boitierList.get(boitierList.size() - 1);
        assertThat(testBoitier.getBoitierReference()).isEqualTo(UPDATED_BOITIER_REFERENCE);
    ...
    void partialUpdateBoitierWithPatch() throws Exception {
        ...
        partialUpdatedBoitier.type(UPDATED_TYPE).nbrBranche(UPDATED_NBR_BRANCHE);
    ...
    void fullUpdateBoitierWithPatch() throws Exception {
        ...
        partialUpdatedBoitier.boitierReference(UPDATED_BOITIER_REFERENCE).type(UPDATED_TYPE).nbrBranche(UPDATED_NBR_BRANCHE);
